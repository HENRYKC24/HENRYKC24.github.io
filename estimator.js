...
let mregion = document.querySelector('#mild-result #re'),
mrc = document.querySelector('#mild-result #rc'),
mci = document.querySelector('#mild-result #ci'),
meip = document.querySelector('#mild-result #eip'),
mesip = document.querySelector('#mild-result #esip'),
meahb = document.querySelector('#mild-result #eahb'),
meipicu = document.querySelector('#mild-result #eipicu'),
meipv = document.querySelector('#mild-result #eipv'),
meedl = document.querySelector('#mild-result #eedl'),
metel = document.querySelector('#mild-result #etel'),
sregion = document.querySelector('#severe-result #re'),
sci = document.querySelector('#severe-result #ci'),
src = document.querySelector('#severe-result #rc'),
seip = document.querySelector('#severe-result #eip'),
sesip = document.querySelector('#severe-result #esip'),
seahb = document.querySelector('#severe-result #eahb'),
seipicu = document.querySelector('#severe-result #eipicu'),
seipv = document.querySelector('#severe-result #eipv'),
seedl = document.querySelector('#severe-result #eedl'),
setel = document.querySelector('#severe-result #etel');
